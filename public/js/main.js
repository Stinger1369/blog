...
//       console.log("Bouton 'Afficher les commentaires' cliqué");
...
//   // console.log("Décalage :", offset);

// // const ajaxUrl = BASE_URL + "/comments/loadMore/" + postId + "/" + offset + "/2";
// // console.log("URL de la requête AJAX :", ajaxUrl);
//   $.ajax({
//     url: BASE_URL + "/comments/loadMore/" + postId + "/" + offset + "/2",
...
//     },
//   });
//   console.log(BASE_URL + "/comments/loadMore/" + postId + "/" + offset + "/2");
